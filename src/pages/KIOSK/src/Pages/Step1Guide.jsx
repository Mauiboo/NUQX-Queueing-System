    ...
    <div className="flex flex-col xl:fixed w-full min-h-screen xl:min-h-full h-full xl:h-screen xl:overflow-hidden">
      <main className="flex flex-col justify-start xl:justify-between flex-1 h-full">
        ...
        <div className="flex flex-col xl:flex-row h-full items-center  w-full mx-auto">
          <div className="flex flex-col items-center text-white grow bg-[#35408e] xl:h-full w-full xl:w-[40%]  justify-center xl:justify-start px-4">
            ...
            <ol className="text-2xl xl:text-4xl xl:mt-[10rem] xl:ml-0 list-decimal list-inside">
              <li>
                <b className="whitespace-nowrap">Choose a Department:</b>
